        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="email" class="col-md-4 col-form-label text-md-end text-start">User Id</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('userId') is-invalid @enderror" id="email" name="userId" value="{{ $user->userId }}">
